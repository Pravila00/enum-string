...
class EnumStringBase
{
    // Types
protected:
    typedef std::map<utility::string_t, EnumType> AssocMap;
...
protected:
    ...
    static void RegisterEnumerator(const EnumType e, const utility::string_t& eStr);

public:
    // Converts from an enumerator to a string.
    // Returns an empty string if the enumerator was not registered.
    static const utility::string_t& From(EnumType&& e);

    static const utility::string_t& From(const EnumType& e);

    // Converts from a string to an enumerator.
    // Returns true if the conversion is successful; false otherwise.
    static const bool To(EnumType& e, const utility::string_t& str);
};
...
template <class D, class E>
void EnumStringBase<D, E>::RegisterEnumerator(const E e, const utility::string_t& eStr)
{
...
template <class D, class E>
const utility::string_t& EnumStringBase<D, E>::From(E&& e)
{
    return From(e);
}

template <class D, class E>
const utility::string_t& EnumStringBase<D, E>::From(const E& e)
{
    for (;;) // Code block
    {
    ...
    static const utility::string_t dummy;
    return dummy;
}

template <class D, class E>
const bool EnumStringBase<D, E>::To(E& e, const utility::string_t& str)
{
